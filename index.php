      ...
      AFRAME.registerComponent("event-snow", {
        init: function () {
          ...
          el.addEventListener("click", function () {
            ...
            audioBackgroud.src =
              "./assets/audios/audios backgroud music/Snow_Scene_Background_Music.mp3";
      ...
      AFRAME.registerComponent("event-debris", {
        init: function () {
          ...
          el.addEventListener("click", function () {
            ...
            audioBackgroud.src =
              "./assets/audios/audios backgroud music/Debris Scene_Background_Music.mp3";
            audioBackgroud.volume = parseInt(audioBackgroud1) / 100;
            audioVoicer.src =
              "./assets/audios/audios voiceovers/Debris_Post.mp3";
            audioVoicer.volume = parseInt(audioVoicer1) / 100;
      ...
      AFRAME.registerComponent("event-rain", {
        init: function () {
          ...
          el.addEventListener("click", function () {
            ...
            audioBackgroud.src =
              "./assets/audios/audios backgroud music/Rain_Scene_Background_Music.mp3";
            audioBackgroud.volume = parseInt(audioBackgroud1) / 100;
      ...
      AFRAME.registerComponent("event-insects", {
        init: function () {
          ...
          el.addEventListener("click", function () {
            ...
            butonPaused.setAttribute("position", "0 -3 0");
            audioBackgroud.src =
              "./assets/audios/audios backgroud music/Insects_Scene_Background_Music.mp3";
            audioBackgroud.volume = parseInt(audioBackgroud1) / 100;
            audioVoicer.src =
              "./assets/audios/audios voiceovers/Insects_Post.mp3";
            audioVoicer.volume = parseInt(audioVoicer1) / 100;
      ...
      AFRAME.registerComponent("event-glare", {
        init: function () {
          ...
          el.addEventListener("click", function () {
            ...
            butonPaused.setAttribute("position", "0 -3 0");
            audioBackgroud.src =
              "./assets/audios/audios backgroud music/Glare Scene_Background_Music.mp3";
            audioBackgroud.volume = parseInt(audioBackgroud1) / 100;
            audioVoicer.src =
              "./assets/audios/audios voiceovers/Glare_Post.mp3";
            audioVoicer.volume = parseInt(audioVoicer1) / 100;
      ...
      AFRAME.registerComponent("event-videp-end", {
        init: function () {
          ...
          var voiceoversList = [
            "./assets/audios/audios voiceovers/Debris_Post.mp3",
            "./assets/audios/audios voiceovers/Glare_Post.mp3",
            "./assets/audios/audios voiceovers/Rain_Post.mp3",
            "./assets/audios/audios voiceovers/Snow_Post.mp3",
          ];
    ...
    >
      <a-assets>
        <video
          ...
          src="assets/videos/insects.mp4"
        ></video>
        <video
          id="videoabout"
          preload="auto"
          crossorigin="anonymous"
          src="assets/videos/ceramx_window_treatment (360p).mp4"
        ></video>
        <audio
          id="audioMainMenu"
          loop
        ...
        <audio
          id="audioBackgroud"
          src="./assets/audios/audios backgroud music/Insects_Scene_Background_Music.mp3"
        ></audio>
        <audio
          id="audioVoicer"
          src="assets/audios/audios voiceovers/Insects_Post.mp3"
        ></audio>
        ...
        <img id="rectangle" src="assets/retagulo.png" />
        <img id="rectangle_white" src="assets/rectangle_white.png" />
      </a-assets>
      ...
      <a-entity id="scene1" visible="true" position="0 0 0">
        ...
        <a-entity id="mainMenu" visible="false" position="0 25 0">
          <!-- curved principal -->
          <a-curvedimage
            height="6"
            radius="10"
