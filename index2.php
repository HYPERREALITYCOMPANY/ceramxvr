...
<body>
    <a-scene test>
        <a-assets>
            <video id="testVideo" preload="auto" loop="true" src="assets/videos/debris.mp4"> </video>
        ...
        <a-camera id="camera1" fov="50" reverse-mouse-drag="true" position="0 1.5 8" rotation="0 250 0"
            ...
            <a-cursor id="cursor1" material="color: white; fuse:true" scale="1.5 1.5 1.5"></a-cursor>
        </a-camera>

        <!-- <a-entity camera look-controls>
            <a-cursor id="cursor" color="green" scale="1 1 1"
                animation__grow="property: scale; to: 2 2 2; startEvents: mouseenter;"
                animation__shrink="property: scale; to: 1 1 1; startEvents: mouseleave;"></a-cursor>
        </a-entity> -->
